...
- [ ] 3.6 After the PR is normally merged, verify the published merge revision and live controller evidence, record exact review/CI/merge links on #1430, and close it only when its acceptance evidence is complete.
