...
here is the restriction of a functor or bifunctor, and of an adjunction, to the
subcategories picked out by a property and its inverse image, and closure of a
left orthogonal under colimits.
-/
