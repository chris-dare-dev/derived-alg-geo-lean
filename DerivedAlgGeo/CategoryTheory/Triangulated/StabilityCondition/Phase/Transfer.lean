...
import DerivedAlgGeo.CategoryTheory.Triangulated.StabilityCondition.Phase.Transfer.BaseChange
...
that transfer, the adjoint transposition that turns the paper's pushforward
criterion into the inducing hypothesis, and semistability under base change.
-/
