...
The public umbrella for the repository's derived algebraic geometry library.

Like `Mathlib.lean`, this root follows a subject hierarchy rather than the
history of the repositories from which the development was assembled.
-/
