...
foundations and `Dqc` use their geometry-owned namespaces; Fourier--Mukai and
stability-specific declarations retain staged namespaces until their separate
cutovers.
-/
