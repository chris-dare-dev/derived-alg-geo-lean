...
-- dg-enhancements-e8, the full dg subcategory root. `DGFullSubcategory P` is
-- the objects of a dg category satisfying `P`, with the ambient Hom-complexes
-- unchanged: every `DGCategory` field is the ambient field applied and every
-- axiom the ambient axiom, which is why `dgCategory` and `linear` carry no
-- proof of their own. `ext_iff` is generated by the `@[ext]` attribute on
-- `ext`, not written; it is recorded because the sweep sees it.
#print axioms CategoryTheory.DGFullSubcategory
#print axioms CategoryTheory.DGFullSubcategory.ClosedUnderCone
#print axioms CategoryTheory.DGFullSubcategory.ClosedUnderShift
#print axioms CategoryTheory.DGFullSubcategory.ContainsZeroObject
#print axioms CategoryTheory.DGFullSubcategory.closedUnderCone_true
#print axioms CategoryTheory.DGFullSubcategory.closedUnderShift_true
#print axioms CategoryTheory.DGFullSubcategory.containsZeroObject_true
#print axioms CategoryTheory.DGFullSubcategory.dgCategory
#print axioms CategoryTheory.DGFullSubcategory.dgComp_eq
#print axioms CategoryTheory.DGFullSubcategory.dgComp_id_eq
#print axioms CategoryTheory.DGFullSubcategory.dgHom_eq
#print axioms CategoryTheory.DGFullSubcategory.dgId_comp_eq
#print axioms CategoryTheory.DGFullSubcategory.dgId_eq
#print axioms CategoryTheory.DGFullSubcategory.ext
#print axioms CategoryTheory.DGFullSubcategory.ext_iff
#print axioms CategoryTheory.DGFullSubcategory.homModule
#print axioms CategoryTheory.DGFullSubcategory.iota
#print axioms CategoryTheory.DGFullSubcategory.iota_linear
#print axioms CategoryTheory.DGFullSubcategory.iota_map_apply
#print axioms CategoryTheory.DGFullSubcategory.iota_map_smul
#print axioms CategoryTheory.DGFullSubcategory.iota_obj
#print axioms CategoryTheory.DGFullSubcategory.isConeOfRestrict
#print axioms CategoryTheory.DGFullSubcategory.isPretriangulated
#print axioms CategoryTheory.DGFullSubcategory.isShiftByRestrict
#print axioms CategoryTheory.DGFullSubcategory.linear
#print axioms CategoryTheory.DGFullSubcategory.obj
#print axioms CategoryTheory.DGFullSubcategory.obj_mk
#print axioms CategoryTheory.DGFullSubcategory.prop
#print axioms CategoryTheory.DGFullSubcategory.struct

-- The two models, and the one lemma Mathlib does not already have. The three
-- closure conditions are properties of the predicate alone, each discharged
-- from Mathlib: shifts by its `(L⟦n⟧).IsKInjective` instance, cones by
-- `isKInjective_mappingCone` -- the orthogonality characterisation joined to
-- `ext_of_isTriangulatedClosed₃` -- and non-vacuity by
-- `isKInjective_of_injective`. `DdgProj` is the K-projective dual and the
-- second consumer of the root; it differs only in the predicate.
#print axioms CategoryTheory.Cdg.Ddg
#print axioms CategoryTheory.Cdg.Ddg.instDGCategoryDdg
#print axioms CategoryTheory.Cdg.Ddg.ofGE
#print axioms CategoryTheory.Cdg.DdgProj
#print axioms CategoryTheory.Cdg.DdgProj.instDGCategoryDdgProj
#print axioms CategoryTheory.Cdg.DdgProj.ofLE
#print axioms CategoryTheory.Cdg.IsKInjectiveObj
#print axioms CategoryTheory.Cdg.IsKProjectiveObj
#print axioms CategoryTheory.Cdg.closedUnderCone_isKInjectiveObj
#print axioms CategoryTheory.Cdg.closedUnderCone_isKProjectiveObj
#print axioms CategoryTheory.Cdg.closedUnderShift_isKInjectiveObj
#print axioms CategoryTheory.Cdg.closedUnderShift_isKProjectiveObj
#print axioms CategoryTheory.Cdg.containsZeroObject_isKInjectiveObj
#print axioms CategoryTheory.Cdg.containsZeroObject_isKProjectiveObj
#print axioms CategoryTheory.Cdg.instIsPretriangulatedDdg
#print axioms CategoryTheory.Cdg.instIsPretriangulatedDdgProj
#print axioms CategoryTheory.Cdg.isKInjectiveObj_iff
